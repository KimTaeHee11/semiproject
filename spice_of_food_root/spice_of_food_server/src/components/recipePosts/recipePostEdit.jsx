...
export default function RecipePostEdit() {
    ...
    const updatePost = useRecipePostStore((s) => s.updatePost);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { name, title, recipe_name, ingredients, content, newFile } = formData;
            ...
            navigate(`/recipePosts/recipePostView/${id}`);
        } catch (error) {
            console.error(error);
