...
import { apiCreatePost, apiCreatePostFileUp } from '../../api/ingrePostApi';
...
export default function IngrePostForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            data.append('ingredient_category', formData.ingredient_category);
